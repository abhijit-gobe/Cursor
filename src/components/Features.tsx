...
const FeatureCard = ({ 
  ...
  return (
    <div 
      className={cn(
        'group glass-panel rounded-lg overflow-hidden p-6 transition-all duration-300 hover:border-white/20',
        className
      )}
    >
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <FeatureCard
            ...
            icon={
              <div className="relative w-12 h-12">
                <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 transform -rotate-12"></div>
                <div className="absolute top-2 left-2 w-10 h-10 bg-gradient-to-br from-green-500 to-blue-500 transform rotate-12"></div>
              </div>
            }
          />
          ...
          <FeatureCard
            ...
            icon={
              <div className="w-12 h-12 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-red-500"></div>
            }
          />
        </div>
      </Container>
